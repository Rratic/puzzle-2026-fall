...
const compassLevel = {
  ...
  blocks: [
    ...
    textBlock(new URL("./content/transfer.html", import.meta.url)),
    puzzle("长度转移", PUZZLES.transfer),
    textBlock(new URL("./content/midpoint.html", import.meta.url)),
    puzzle("作中点", PUZZLES.midpoint),
    textBlock(new URL("./content/inversion.html", import.meta.url)),
    puzzle("点的反演", PUZZLES.inversion),
    textBlock(new URL("./content/circumcenter.html", import.meta.url)),
    puzzle("三角形外心", PUZZLES.circumcenter),
    textBlock(new URL("./content/line-line.html", import.meta.url)),
    puzzle("直线与直线交点", PUZZLES.lineLine),
    textBlock(new URL("./content/line-circle.html", import.meta.url)),
